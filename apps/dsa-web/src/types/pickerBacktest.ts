...
export type PickerStrategy = 'buy_pullback' | 'breakout' | 'bottom_reversal' | 'reversal_breakout' | 'small_cap';
...
export interface PickerBacktestResultItem {
  ...
  holdDays?: number;
  strategyId?: string;  // buy_pullback / breakout / bottom_reversal / reversal_breakout / small_cap
}
