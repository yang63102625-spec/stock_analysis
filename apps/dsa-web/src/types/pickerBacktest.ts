...
export type PickerStrategy = 'buy_pullback' | 'bottom_reversal' | 'reversal_breakout' | 'small_cap';
...
export interface PickerBacktestResultItem {
  ...
  holdDays?: number;
  strategyId?: string;  // buy_pullback / bottom_reversal / reversal_breakout / small_cap
}
