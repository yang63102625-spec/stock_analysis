  ...
  return (
    <div className="h-screen flex flex-col max-w-6xl mx-auto w-full px-6 py-6">
      <div className="mb-5 flex-shrink-0 flex items-center gap-2.5">
        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-purple/15 to-cyan/10 flex items-center justify-center shadow-sm">
        ...
        <h1 className="text-lg font-semibold text-primary tracking-tight">AI 问股</h1>
      </div>
