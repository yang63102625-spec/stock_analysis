...
| AI 选股 | 量化筛选 + 实时过滤 + LLM 精选 1–5 只（买回踩/突破/底部反转/尾盘买入），输出**理想买入价 / 止损 / 首止盈 / 盈亏比 / 仓位建议**，盈亏比 R/R<1.8 自动剔除，多策略共振加分 |
...
- **Trailing 阶梯止盈**：浮盈 5% 减 1/3 + 止损上移至成本 → 浮盈 10% 再减 1/3 + 止损至 +5% → 浮盈 >20% trailing（跌破 MA10 或回撤 ATR×2.5），让强势股利润奔跑
- **盈亏比硬过滤**：R/R < 1.8 直接剔除；2/3 策略共振 +10/+20 加分
- **基本面硬否决**：高质押 / 高商誉 / 大额减持 / 业绩预减股 picker 入池前剔除
- 止损建议：小盘 -5% / 中盘 -6% / 大盘 -7%，配合 MA20 技术止损
