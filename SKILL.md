...
本技能基于 `src/services/programmatic.py` 的逻辑，提供分析股票和整体市场的功能。
...
```python
from src.services.programmatic import analyze_stock
...
**参考:** [`analyze_stock`](src/services/programmatic.py)
...
```python
from src.services.programmatic import analyze_stocks
...
**参考:** [`analyze_stocks`](src/services/programmatic.py)
...
```python
from src.services.programmatic import perform_market_review
...
**参考:** [`perform_market_review`](src/services/programmatic.py)
